...
import type { SearchOptions, Folder } from "@/components/types";
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked: boolean) => updateSearchOption("use_reranking", checked)}
            />
          </div>
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked: boolean) => updateSearchOption("use_colpali", checked)}
            />
          </div>
          <div>
